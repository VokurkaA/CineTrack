 ...
 */
export interface ListGroupRootProps extends HTMLAttributes<HTMLDivElement> {
  /**
 ...
 */
export interface ListGroupItemProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  /**
  ...
  className?: string;
  /**
   * Press event extending default button action
   */
 ...
 */
export interface ListGroupItemPrefixProps extends HTMLAttributes<HTMLDivElement> {
  /**
 ...
 */
export interface ListGroupItemContentProps extends HTMLAttributes<HTMLDivElement> {
  /**
 ...
 */
export interface ListGroupItemTitleProps extends HTMLAttributes<HTMLSpanElement> {
  /**
 ...
 */
export interface ListGroupItemDescriptionProps extends HTMLAttributes<HTMLSpanElement> {
  /**
 ...
 */
export interface ListGroupItemSuffixProps extends HTMLAttributes<HTMLDivElement> {
  /**
